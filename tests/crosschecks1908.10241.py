...
t_0, a_0, e_0 = inspiral.Classic.evolve_elliptic_binary(sp_0, a0, e0, afin)
t_1, a_1, e_1 = inspiral.Classic.evolve_elliptic_binary(sp_1, a0, e0, afin, acc=1e-11)
t_2, a_2, e_2 = inspiral.Classic.evolve_elliptic_binary(sp_2, a0, e0, afin, acc=1e-10)
t_3, a_3, e_3 = inspiral.Classic.evolve_elliptic_binary(sp_3, a0, e0, afin, acc=1e-13)
